...
def postclean_ai_script(text: str) -> str:
    ...
    cleaned = _collapse_whitespace(text)
    # Strip stray wrapping quotes the model occasionally adds around the whole output.
                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "Your job: take the source text and produce a version that sounds natural when a human reads it aloud, while keeping it as close to the original as possible.\n\n"
                            "Quality target: the output should sound like \"a clean version of the original post that a human would naturally read aloud\" — NOT raw Reddit text, NOT an AI rewrite, NOT scripted YouTube narration.\n\n"
                            "Editing rules (allowed):\n"
                            "1. Fix grammar and capitalization.\n"
                            "2. Add missing punctuation — this is critical. Every sentence must end with a period, question mark, or exclamation mark.\n"
                            "3. Split run-on sentences into clean separate sentences.\n"
                            "4. Combine broken fragments into complete, grammatical sentences.\n"
                            "5. Slightly rephrase ONLY when necessary for clarity — keep original wording otherwise.\n"
                            "6. Expand abbreviations and internet slang for speech:\n"
                            "   - AITA / AITAH -> \"Am I the asshole\"\n"
                            "   - WIBTA -> \"Would I be wrong\"\n"
                            "   - IATA -> \"I am the asshole\"\n"
                            "   - TIL -> \"Today I learned\"\n"
                            "   - TIFU -> \"Today I messed up\"\n"
                            ...
                            "   - w/ -> \"with\"\n"
                            "   - w/o -> \"without\"\n"
                            "7. Normalize numbers, time, and currency into natural spoken English:\n"
                            "   - 3am -> \"three a.m.\" or \"three in the morning\"\n"
                            "   - £20k -> \"twenty thousand pounds\"\n"
                            "   - $5k -> \"five thousand dollars\"\n"
                            "   - 24 -> \"twenty-four\" (only for small standalone numbers that sound better as words)\n"
                            "8. Hook improvement (FIRST SENTENCE ONLY):\n"
                            "   - Lightly rewrite ONLY the first sentence to create mild curiosity, tension, or intrigue.\n"
                            "   - Keep the wording close to the original. Do NOT invent new story content.\n"
                            "   - Do NOT exaggerate or use false clickbait.\n"
                            "   - Add a trailing phrase like '…and I didn't know what to think' or 'and something felt off' ONLY if it fits naturally.\n"
                            "   - Leave the rest of the script unchanged except for the existing editing rules.\n"
                            "9. Pacing (ALL sentences):\n"
                            "   - Break long sentences into shorter spoken units — aim for 1–2 clauses per sentence.\n"
                            "   - Use commas and periods to create natural speech pauses.\n"
                            "   - Do NOT change meaning or aggressively shorten the story.\n"
                            "   - Goal: short → clear → punchy → continuous.\n"
                            "10. Curiosity gap:\n"
                            "    - Do NOT resolve outcomes early.\n"
                            "    - Do NOT summarize the ending before it happens.\n"
                            "    - Keep the sequence strictly chronological.\n"
                            "    - The viewer should feel 'what happens next?' throughout.\n\n"
                            "Length guidance:\n"
                            "- Do NOT artificially extend or add filler.\n"
                            "- Do NOT stretch weak content.\n"
                            "- Keep the script as tight as possible.\n"
                            "- If the story naturally supports 40–70 seconds of spoken content, aim for that range.\n"
                            "- If not, shorter is better than stretched.\n\n"
                            "Strict prohibitions (NOT allowed):\n"
                            "- Do NOT heavily paraphrase or change the story.\n"
                            "- Do NOT change story order.\n"
                            "- Do NOT add new ideas, context, or dramatic flair.\n"
                            "- Do NOT aggressively shorten.\n"
                            "- Do NOT make it \"more viral\".\n"
                            "- Do NOT add stylistic fluff.\n"
                            "- Do NOT produce raw Reddit-style text.\n"
                            "- Do NOT produce AI-rewrite-style text.\n"
                            "- Do NOT produce scripted YouTube narration style.\n\n"
